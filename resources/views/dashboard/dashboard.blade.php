            ...
            <div class="card">
                <div class="card-body text-center">
                    <div class="list-menu">
                        ...
                        <div class="item-menu text-center">
                            <div class="menu-icon">
                                <a href="/presensi/cuti" class="danger item {{request()->is('presensi/cuti') ? 'active' : '' }} " style="font-size: 40px;">
                        ...
                        <div class="item-menu text-center">
                            <div class="menu-icon">
                                <a href="/presensi/izin" class="warning item {{request()->is('presensi/izin') ? 'active' : '' }} " style="font-size: 40px;">
                        ...
                        <div class="item-menu text-center">
                            <div class="menu-icon">
                                <a href="/presensi/histori" class="primary item {{request()->is('presensi/histori') ? 'active' : '' }} " style="font-size: 40px;">
            ...
            <div class="row mt-1">
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <span style="font-size: 0.8rem; font-weight:500">Telat</span></div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="historicontent">
                                ...
                                <div class="datapresensi">
                                    ...
                                    <span>{!! date("H:i", strtotime($d->jam_in)) > date("H:i", strtotime($d->jam_masuk)) ?
                                        '<span class="text-danger">Terlambat</span>' : '<span class="text-success">Tepat Waktu</span>' !!}</span>
                                </div>
                            </div>
                        </div>
                    </div>
