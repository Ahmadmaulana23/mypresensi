...
<div class="page-header d-print-none">
        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row">
                    <div class="col-12">
                        <form action="/presensi/pengajuancuti" method="GET" autocomplete="off">
                            <div class="row">
                                <div class="col-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" id="approve" class="btn btn-sm btn-primary" id="approve" id_cuti="{{$d->id}}">
                                        ...
                                        @else
                                        <a href="/presensi/{{$d->id}}/batalkancuti" class="btn btn-sm btn-danger">
