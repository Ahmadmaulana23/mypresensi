...
class KonfigurasiController extends Controller
{
    ...
    public function setjamkerja($nik)
    {
        ...
        $cekjamkerja = DB::table('konfig_jamkerja')->where('nik', $nik)->count();
        if ($cekjamkerja > 0) {
            $setjamkerja = DB::table('konfig_jamkerja')->where('nik', $nik)->get();
    ...
    public function updatesetjamkerja(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('konfig_jamkerja')->where('nik', $nik)->delete();
            Setjamkerja::insert($data);
            DB::commit();
